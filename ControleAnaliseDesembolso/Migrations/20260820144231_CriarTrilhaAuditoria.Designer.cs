...
namespace ControleAnaliseDesembolso.Migrations
{
    ...
    [Migration("20260820144231_CriarTrilhaAuditoria")]
    partial class CriarTrilhaAuditoria
    {
            ...
            modelBuilder.Entity("ControleAnaliseDesembolso.Domain.Entitys.TrilhaAuditoria", b =>
                {
                    ...
                    b.HasKey("CoTrilhaAuditoria")
                        .HasName("PK_TB001_TRILHA_AUDITORIA");

                    b.ToTable("TB001_TRILHA_AUDITORIA", (string)null);
                });
